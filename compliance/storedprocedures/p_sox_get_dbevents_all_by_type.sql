...
/****** Object:  StoredProcedure [dbo].[p_sox_get_dbevents_all_by_type]    Script Date: 6/29/2012 2:14:09 PM ******/
DROP PROCEDURE [dbo].[p_sox_get_dbevents_all_by_type]
GO
...
-- =======================================================
-- p_sox_get_dbevents_all_by_type
--
-- Arguments:	None
--				None
--
...
-- ========================================================
CREATE PROCEDURE [dbo].[p_sox_get_dbevents_all_by_type] 
...
GRANT EXECUTE ON [dbo].[p_sox_get_dbevents_all_by_type] TO [db_proc_exec] AS [dbo]
GO
