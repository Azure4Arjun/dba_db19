USE [test]
GO
/****** Object:  StoredProcedure [dbo].[p_tes_object_check_permission]    Script Date: 03/09/2009 11:51:22 ******/
SET ANSI_NULLS ON
GO
...
/******************************************************************************
**		 
**		Name: [p_tes_object_check_permission]
...
ALTER Procedure [dbo].[p_tes_object_check_permission]
@database varchar(50)
As
BEGIN
