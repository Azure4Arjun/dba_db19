...
NET USE W:/delete
NET USE w: \\usnypflpt2\data\users\atekulsky @Lawrence92 /user:iie\atekulsky


copy /D /I /S /Y /Z C:\VmWare\HardDisks\"windows_7_x32_vm.vmdk"  w:\"My Documents"\vdi-safety\*.*
copy /D /I /S /Y /Z C:\VmWare\HardDisks\"windows_XP_x32_vm.vmdk" w:\"My Documents"\vdi-safety\*.*
copy /D /I /S /Y /Z C:\VmWare\HardDisks\"window_7_x64.vmdk"      w:\"My Documents"\vdi-safety\*.*
