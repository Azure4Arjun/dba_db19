...
NET USE w: \\usnypflpt1\shared @Lawrence92 /user:iie\atekulsky
...
NET USE x: \\usnypflpt2\data\users\atekulsky @Lawrence92 /user:iie\atekulsky


xcopy /D /I /S /Y /Z C:\VmWare\HardDisks\"windows_7_x32_vm.vmdk"  x:\"My Documents"\vdi-safety\*.*
xcopy /D /I /S /Y /Z C:\VmWare\HardDisks\"windows_XP_x32_vm.vmdk" x:\"My Documents"\vdi-safety\*.*
xcopy /D /I /S /Y /Z C:\VmWare\HardDisks\"window_7_x64.vmdk"      x:\"My Documents"\vdi-safety\*.*
