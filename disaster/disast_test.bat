...
rem ***xcopy /D /I /S /Y /Z C:\virtualbox\HardDisks\"windows 7 x32 vm.vdi" w:\"My Documents"\vdi_safety\*.*
rem ***xcopy /D /I /S /Y /Z C:\VirtualBox\HardDisks\"windows XP x32 vm.vdi" w:\"My Documents"\vdi_safety\*.*
rem ***xcopy /D /I /S /Y /Z C:\VirtualBox\HardDisks\"windows 7 x64 vm.vdi" w:\"My Documents"\vdi_safety\*.*
