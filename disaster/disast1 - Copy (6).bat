...
xcopy /D /I /S /Y /Z C:\VmWare\HardDisks\"windows_7_x32_vm.vmdk" w:\"My Documents"\vdi-safety\*.*
xcopy /D /I /S /Y /Z C:\VmWare\HardDisks\"windows_XP_x32_vm.vmdk" w:\"My Documents"\vdi-safety\*.*
xcopy /D /I /S /Y /Z C:\VmWare\HardDisks\"window_7_x64.vmdk" w:\"My Documents"\vdi-safety\*.*
