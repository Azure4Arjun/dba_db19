...
-- Model
--
--ALTER DATABASE model MODIFY FILE (NAME = modeldev, FILENAME = 'F:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Data\modeldb.mdf')
--GO
...
-- Master
--
--ALTER DATABASE master MODIFY FILE (NAME = master, FILENAME = 'F:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Data\master.mdf')
--GO

--ALTER DATABASE master MODIFY FILE (NAME = mastlog, FILENAME = 'S:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Log\mastlog.ldf')
--GO

ALTER DATABASE EDW MODIFY FILE (NAME = N'EDW_log', FILENAME = N'N:\MSSQL\TRAN01\EDW_log.ldf');
...
-- --     MODIFY FILE (NAME=data, FILENAME= 'F:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Data\mssqlsystemresource.mdf');

-- ALTER DATABASE mssqlsystemresource 
--     MODIFY FILE (NAME=log, FILENAME= 'F:\Program Files\Microsoft SQL Server\MSSQL.1\MSSQL\Data\mssqlsystemresource.ldf');
