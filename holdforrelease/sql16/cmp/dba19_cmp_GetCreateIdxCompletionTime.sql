...
GO
-- ======================================================================================
-- dba19_cmp_GetCreateIdxCompletionTime
--
--
-- Calls:		None
--
-- Description:	Get an estimat of the time remaining on a create index operation.
-- 
...
-- 04/21/2020   Aron E. Tekulsky    Update to Version 150.
-- ======================================================================================
		...
		,CONVERT(VARCHAR(1000), (
			SELECT SUBSTRING(TEXT, r.statement_start_offset / 2,
				CASE
					...
					END) 'Statement text'
				FROM sys.dm_exec_sql_text(sql_handle))) AS 'Statement text'
			FROM sys.dm_exec_requests r
	WHERE UPPER(command) LIKE 'CREATE INDEX%' OR UPPER(command) LIKE 'DROP INDEX%';
