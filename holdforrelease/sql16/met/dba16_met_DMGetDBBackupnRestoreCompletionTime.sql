...
GO
-- ======================================================================================
-- db16_met_GetDBBackupnRestoreCompletionTime
--
--
-- Calls:		None
--
-- Description:	Get a listing of backup and restore jobs running on teh server
--				and estimates on completeion etc.
-- 
---- http://www.dharmendrakeshari.com/get-estimated-completion-time-sql-serverdatabase-
--		backup-restore/
