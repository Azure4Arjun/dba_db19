...
-- ======================================================================================
--
CREATE PROCEDURE p_dba19_sys_GetDBSize
...
-- update with the row sizes
					SET @Cmd = 'UPDATE #dbsize
							 SET rowlen = v.rowlength
								FROM ' +  @dbname +  '..v_dba19_sys_RowLength ' + 'v,
								#dbsize d
...
END
GO
GRANT EXECUTE ON p_dba19_sys_GetDBSizeTO [db_proc_exec] AS [dbo];
GO
