...
GO
-- ======================================================================================
-- p_dba16_dig_GetDeadlockSQLExecting
--
-- Arguments:	@TheSQLStatement nvarchar(4000)
--				None
--
-- CallS:		None
--
-- Called BY:	p_dba14_alt_GetAlertResponse
--
-- Description:	Get the SQL code that is causing the deadlock.
-- 
...
-- ======================================================================================
--
CREATE PROCEDURE p_dba16_dig_GetDeadlockSQLExecting 
	-- Add the parameters for the stored procedure here
	@TheSQLStatement nvarchar(4000)
AS
BEGIN
...
END
GO
GRANT EXECUTE ON p_dba16_dig_GetDeadlockSQLExecting TO [db_proc_exec] AS [dbo]
GO
