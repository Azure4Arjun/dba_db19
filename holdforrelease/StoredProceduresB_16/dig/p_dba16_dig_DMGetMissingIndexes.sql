...
GO
-- ======================================================================================
-- p_dba16_dig_DMGetMissingIndexes
--
-- Arguments:	None
--				None
--
...
-- Called BY:	None
--
-- Description:	Find out if there are any missing indexes on tables in each database
...
-- ======================================================================================
--
CREATE PROCEDURE p_dba16_dig_DMGetMissingIndexes 
...
END
GO
GRANT EXECUTE ON p_dba16_dig_DMGetMissingIndexes TO [db_proc_exec] AS [dbo]
GO
