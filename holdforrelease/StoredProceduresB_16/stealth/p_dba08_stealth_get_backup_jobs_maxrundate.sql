...
/****** Object:  StoredProcedure [dbo].[p_dba08_stealth_get_backup_jobs_maxrundate]    Script Date: 8/17/2016 8:12:11 AM ******/
DROP PROCEDURE [dbo].[p_dba08_stealth_get_backup_jobs_maxrundate]
GO
...
-- ==============================================================================
-- p_dba08_stealth_get_backup_jobs_maxrundate
--
-- Arguments:	None
--				None
--
...
-- ===============================================================================
--	Copyright©2008 - 2012 Aron Tekulsky.  World wide rights reserved.
--	Use of this code is free of charge but does not in any way imply transfer of 
--	Copyright ownership to the user.
-- ===============================================================================

CREATE procedure [dbo].[p_dba08_stealth_get_backup_jobs_maxrundate] 
...
AS
	...
	--	name			sysname)
		...
		PRINT @cmd
			...
			INSERT dba_db08.dbo.dbbackups (servern, instance_id, job_id, step_id, step_name,
