...
GO
-- ======================================================================================
-- p_dba16_utl_GetFileNameWithDateOutput
--
...
--					@newfilename	nvarchar(1000) OUTPUT
--
--
-- CallS:		None
--
...
-- ======================================================================================
--
CREATE PROCEDURE p_dba16_utl_GetFileNameWithDateOutput 
...
END
GO
GRANT EXECUTE ON p_dba16_utl_GetFileNameWithDateOutput TO [db_proc_exec] AS [dbo]
GO
