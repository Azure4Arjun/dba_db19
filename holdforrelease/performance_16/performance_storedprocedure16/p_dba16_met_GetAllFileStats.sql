...
-- ======================================================================================
--
CREATE PROCEDURE p_dba16_met_GetAllFileStats 
...
BEGIN
	...
	INSERT INTO @vfs
		SELECT database_id,  file_id, sample_ms, num_of_reads, num_of_bytes_read, io_stall_read_ms, num_of_writes, num_of_bytes_written,
...
END
GO
GRANT EXECUTE ON p_dba16_met_GetAllFileStats TO [db_proc_exec] AS [dbo]
GO
