...
/****** Object:  Job [DBA Database Expiration Crawler]    Script Date: 09/14/2010 14:57:46 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 09/14/2010 14:57:46 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Database Expiration Crawler]    Script Date: 09/14/2010 14:57:46 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Database Expiration Crawler', 
		...
		@command=N'EXEC p_dba16_dba_LoadInitialValuesExpiration', 
