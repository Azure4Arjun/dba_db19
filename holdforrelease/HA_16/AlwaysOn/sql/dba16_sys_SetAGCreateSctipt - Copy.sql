...
BEGIN
	...
	SET @AGName			= 'AGBPMP1';
	SET @DBName			= 'test1';
	SET @PrimarySrvr	= 'wcdcbpmdbp01a.nam.ent.duke-energy.com';
	SET @SecondarySrvr	= 'wadcbpmdbp01b.nam.ent.duke-energy.com';
	SET @FailoverMode	= 'AUTOMATIC';
	SET @AvMode			= 'SYNCHRONOUS_COMMIT';
	SET @BackupPrtyp	= 0;
	SET @BackupPrtys	= 50;
	SET @PrimaryCon		= 'NO';
	...
	SET @Cmd = 'CREATE AVAILABILITY GROUP [' + @AGName + ']
		...
		(ALLOW_CONNECTIONS = ' + @PrimaryCon + '))' + CHAR(13);
