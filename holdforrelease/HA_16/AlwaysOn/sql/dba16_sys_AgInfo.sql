...
----
SELECT TOP 1000 'availability_databases_cluster', [group_id]
      ,[group_database_id]
      ,[database_name]
      ,[truncation_lsn]
  FROM [master].[sys].[availability_databases_cluster]

  SELECT TOP 1000 'availability_group_listener_ip_addresses', [listener_id]
      ,[ip_address]
      ,[ip_subnet_mask]
      ,[is_dhcp]
      ,[network_subnet_ip]
  ...
  SELECT TOP 1000 'availability_group_listeners', [group_id]
      ,[listener_id]
      ,[dns_name]
      ,[port]
      ,[is_conformant]
  ...
  SELECT TOP 1000 'availability_groups', [group_id]
      ,[name]
      ,[resource_id]
      ,[resource_group_id]
