...
GO
-- ======================================================================================
-- dba19_xev_ReadBlockedThresholdReportByDateBO
--
--
-- Calls:		None
--
...
--	03/05/2020	Aron E. Tekulsky	Modified to have start and end date for range.
-- ======================================================================================
...
BEGIN
	...
	-- initialize
	SET @StartDate	= '2020-03-04'; -- enter start date. without time assumes midnight.
	SET @EndDate	= '2020-03-04 23:00:00'; -- format yyyy-mm-dd hh:mm:ss.nnnnnnn
