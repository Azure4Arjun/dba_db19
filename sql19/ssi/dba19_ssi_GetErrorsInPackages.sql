...
GO
-- ======================================================================================
-- dba19_ssi_GetErrorsInPackages
--
--
-- Calls:		None
--
-- Description:	Query SSISDB to find out the errors in teh packages.
-- 
-- https://dba.stackexchange.com/questions/118737/how-to-query-ssisdb-to-find-out-the-errors-in-the-packages
--
-- Date			Modified By			Changes
-- 01/03/2020   Aron E. Tekulsky    Initial Coding.
-- 01/03/2020   Aron E. Tekulsky    Update to Version 150.
-- ======================================================================================
...
BEGIN
	...
	SELECT
		...
		FROM SSISDB.catalog.executions AS E
			...
			INNER JOIN SSISDB.catalog.operation_messages m ON (m.operation_id = e.execution_id)
