...
rem ***forfiles -p%1 -d-%history% -c"cmd /c echo @FILE"
rem ***forfiles -p%1 -d-%history% -c"cmd /c del @FILE"
f:\scripts\forfiles -p%1 -d-%history% -c"cmd /c echo @FILE"
f:\scripts\forfiles -p%1 -d-%history% -c"cmd /c del @FILE"
echo Done.
goto EOF
