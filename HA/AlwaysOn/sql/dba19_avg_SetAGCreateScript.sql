...
-- 03/17/2018   Aron E. Tekulsky    Update to Version 140.
...
BEGIN
	...
	SET @Primary		= 'MyServerBoxA\PROD';
	SET @Secondary		= 'MyServerBoxB\PROD';
	SET @Listener		= '';
	SET @PriLogin		= 'MyDomain\MyDomainId';
	SET @SecLogin		= 'MyDomain\MyDomainId';
	...
	SET @AGName			= 'MyAgName';
	SET @DBName			= 'test1';
	SET @PrimarySrvr	= 'MyServerBoxA.MyDomain.com'; -- Use FQDN
	SET @SecondarySrvr	= 'MyServerBoxB.MyDomain.com'; -- Use FQDN
