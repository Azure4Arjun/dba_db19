...
IF object_id(N'dbo.v_dba19_sys_GetAGPrimary', 'V') IS NOT NULL
	DROP VIEW dbo.v_dba19_sys_GetAGPrimary
GO

-- ======================================================================================
-- v_dba19_sys_GetAGPrimary
--
--
-- Calls:		None
--
...
CREATE VIEW dbo.v_dba19_sys_GetAGPrimary AS
