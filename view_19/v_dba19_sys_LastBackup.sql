...
IF object_id(N'dbo.v_dba19_sys_LastBackup', 'V') IS NOT NULL
	DROP VIEW dbo.v_dba19_sys_LastBackup
GO

-- ======================================================================================
-- v_dba19_sys_LastBackup
--
--
-- Calls:		None
--
...
-- 10/19/2010   Aron E. Tekulsky    Initial Coding.
...
CREATE VIEW dbo.v_dba19_sys_LastBackup AS
	SELECT 
		--s.server_name
		--,s.machine_name
		s.database_name
