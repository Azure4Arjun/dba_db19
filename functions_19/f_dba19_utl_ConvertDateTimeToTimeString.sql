...
/****** Object:  UserDefinedFunction [dbo].[f_dba08_convertdatetimetotimestring]    Script Date: 02/26/2009 15:13:00 ******/
SET ANSI_NULLS ON
GO
...
GO
-- ======================================================================================
-- f_dba19_utl_ConvertDateTimeToTimeString
--
...
CREATE FUNCTION [dbo].[f_dba19_utl_ConvertDateTimeToTimeString] 
(
...
GRANT EXECUTE ON [dbo].[f_dba19_utl_ConvertDateTimeToTimeString] TO [db_proc_exec] AS [dbo]
GO

GRANT VIEW DEFINITION ON [dbo].[f_dba19_utl_ConvertDateTimeToTimeString] TO [db_proc_exec] AS [dbo]
GO
