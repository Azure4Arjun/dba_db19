...
-- ======================================================================================
-- f_dba19_sys_RemoveFileNameAndGetPath
--
...
-- Called BY:	None
--
-- Description:	Remove all back slashes from teh string passed.
--
...
-- ======================================================================================
--
CREATE FUNCTION [dbo].[f_dba19_sys_RemoveFileNameAndGetPath] 
(
...
BEGIN
	...
	DECLARE @char_location2		int
	DECLARE @start_pos			int

	SET @char_location = 1;
	SET @char_location2 = 1;
	...
	-- Add the T-SQL statements to compute the return value here
		...
		--	SET @char_location2 = @char_location + 1;
		--	SET @char_location	= @char_location2;
		--	SET @start_pos		= @char_location2;
