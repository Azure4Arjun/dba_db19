...
GO
-- ==============================================================================
-- f_dba19_sys_RemoveLeadingBackSlashPairs
--
...
-- Called BY:		None
--
-- Description:	Strip out leading \\ and replace with \.
-- 
...
-- ======================================================================================
--
CREATE FUNCTION [dbo].[f_dba19_sys_RemoveLeadingBackSlashPairs] 
(	
...
BEGIN
 ...
 --   WHILE (@char_location > 0)
	...
	SET @clean_text = REPLACE (@text_value, '\\','\')
...
GRANT EXECUTE ON [dbo].[f_dba19_sys_RemoveLeadingBackSlashPairs] TO [db_proc_exec]
GO
